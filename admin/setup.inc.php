...
<p><img src="<?php print plugins_url('admin/images/route-53-alias.png', 'cf-page-cache/cf-page-cache.php'); ?>"></p>
...
<p><img src="<?php print plugins_url('admin/images/cf-http-headers-chrome.png', 'cf-page-cache/cf-page-cache.php'); ?>"></p>

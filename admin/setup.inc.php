...
<p><span class="n">1</span> Enter the origin host name in the <strong>Origin Domain Name</strong> field. By default, this plugin differentiates between origin and public hosts by the presence of <code>www.</code> so if your public host is <em>www.your-domain.com</em> then you would enter <em>yourdomain.com</em> as your origin host. If you want to use your root domain then the www. version will be your origin host. You can customize this behaviour by defining <code>CF_FPC_HOST</code> and <code>CF_FPC_ORIGIN_HOST</code> in wp-config.php above the initiation script.</p>

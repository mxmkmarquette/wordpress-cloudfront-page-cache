...
<div class="wrap cloudfrontpagecache-wrapper">
	...
	<div class="metabox-prefs"> 
		<div class="wrap about-wrap" style="position:relative;">
			...
			<div style="position:absolute;top:0px;right:0px;text-align:center;">
				<a href="https://aws.amazon.com/cloudfront/?<?php print $this->aws_tracking; ?>" target="_blank" rel="noopener"><img src="<?php print plugins_url('admin/images/aws-cloudfront-100.png', 'cloudfront-page-cache/cloudefront-page-cache.php'); ?>" border="0" style="border:0px;"></a>
			</div>
	...
	<?php
			...
			<p><img src="<?php print plugins_url('admin/images/pagespeed-aws-cloudfront.png', 'cloudfront-page-cache/cloudefront-page-cache.php'); ?>"></p>
			...
			<p><img src="<?php print plugins_url('admin/images/aws-cloudfront-network-2017.png', 'cloudfront-page-cache/cloudefront-page-cache.php'); ?>"></p>

			<p>This page cache solution makes it possible to use a 5 USD VPS for a heavy WordPress + WooCommerce installation while being capable of handling hundreds of visitors per day (with a fast page speed and good results in Google) for an additional $0.50+ USD per month in AWS costs. For a small business website, the total costs will be less than $1 USD per month while international website speed + Google rankings are of high value.</p>

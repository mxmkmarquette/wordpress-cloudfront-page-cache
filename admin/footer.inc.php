...
<div style="padding:5px;padding-left:10px;padding-top:1px;background:white;">
	...
	<p>For reporting bugs/issues related to this plugin, please use the <a href="https://github.com/optimalisatie/cloudfront-page-cache/issues" target="_blank" rel="noopener">Github Issues forum</a>. Alternatively, you can use the <a href="https://wordpress.org/support/plugin/cf-page-cache/" target="_blank" rel="noopener">WordPress support forum</a>.</p>

	<p>For CloudFront related configuration issues and questions, please use the <a href="https://forums.aws.amazon.com/forum.jspa?forumID=46" target="_blank" rel="noopener">AWS CloudFront support forum</a>.</p>
